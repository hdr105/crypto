	...
	function u(e) {
		if (null !== e) {
			...
			return a.row = $("<tr/>", {
				...
				class: "fast_trade",
				html: "<div class='table-btns'><a href='buy-sell.php' class='btn btn-success mb5 w25'>Buy</a><a href='buy-sell.php' class='btn btn-danger w25'>Sell</a></div>"
			}),a.trade = $("<td/>", {
				class: "trade",
				html: "<div class='table-btns'><a href='buy-sell.php' class='btn btn-success mb5 w25'>Buy</a><a href='buy-sell.php' class='btn btn-danger w25'>Sell</a></div>"
			}),a.trade_top = $("<td/>", {
